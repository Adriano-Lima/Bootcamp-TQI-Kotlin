...
import com.adriano.cred.system.dto.CreditView
import com.adriano.cred.system.dto.CreditViewList
import com.adriano.cred.system.dto.CreditDto
...
class CreditResource(
    ...
    fun findByCreditCode(
        ...
        val credit = this.creditService.findByCredCode(customerId, creditCode)
