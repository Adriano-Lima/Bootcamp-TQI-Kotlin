package com.adriano.cred.system.controller

import com.adriano.cred.system.dto.CustomerDto
...
class CustomerResourceTest {
  ...
  fun `should find customer by id and return 200 status`() {
    ...
    mockMvc.perform(
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Adriano"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Lima"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("adriano@email.com"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua do Adriano, 123"))
      //.andExpect(MockMvcResultMatchers.jsonPath("$.id").value(1))
      .andDo(MockMvcResultHandlers.print())
  }
  ...
  fun `should update a customer and return 200 status`() {
    ...
    mockMvc.perform(
      ...
      .andExpect(MockMvcResultMatchers.status().isOk)
      .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("AdrianoUpdate"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("SaUpdate"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("adriano@email.com"))
  ...
  private fun builderCustomerDto(
    ...
    street: String = "Rua do Adriano, 123",
  ) = CustomerDto(
    firstName = firstName,
    lastName = lastName,
    cpf = cpf,
